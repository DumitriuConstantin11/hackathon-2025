...
class MonthlySummaryService
{
    ...
    public function computeTotalExpenditure(User $user, int $year, int $month): float
    {
        ...
        return $this->expenses->sumAmounts(["user_id" => $user->id, "year" => $year, "month" => $month])/100;
    }
    ...
    public function computePerCategoryTotals(User $user, int $year, int $month): array
    {
        ...
        return $this->expenses->sumAmountsByCategory(["user_id" => $user->id, "year" => $year, "month" => $month]);
    }
    ...
    public function computePerCategoryAverages(User $user, int $year, int $month): array
    {
        ...
        return $this->expenses->averageAmountsByCategory(["user_id" => $user->id, "year" => $year, "month" => $month]);
    }
}
